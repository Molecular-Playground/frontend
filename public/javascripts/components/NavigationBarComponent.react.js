...
var NavigationBar = React.createClass({
  render : function( ){
    return(
        <div className="android-header mdl-layout__header mdl-layout__header--waterfall whiteNav">
          <div className="mdl-layout__header-row">
            ...
            <div className="android-navigation-container">
              <nav className="android-navigation mdl-navigation">
                <a className="mdl-navigation__link mdl-typography--text-uppercase" href="/molecules">Molecules</a>
